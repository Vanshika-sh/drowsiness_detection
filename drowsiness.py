...
ap.add_argument("-a", "--alarm", type=str, default="/home/vanshika/Downloads/alert.wav", help="path alarm .WAV file")
...
while True:
	...
	for rect in rects:
		...
		cv2.putText(frame, "Counter: {:.2f}".format(COUNTER), (300,40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255), 2)
